...
```bash
kubectl config use-context arn:aws:eks:ap-northeast-1:ACCOUNT:cluster/jung-kyeol-mgmt-eks
...
```bash
kubectl config use-context arn:aws:eks:ap-northeast-1:ACCOUNT:cluster/jung-kyeol-dev-eks
